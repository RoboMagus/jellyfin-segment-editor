  ...
  <div class="column">
    <div class="row justify-start items-center">
      <div class="q-mr-xs" style="width: 3px; height: 40px">
        <div
          v-if="idx == activeIdx && showVideoPlayer"
          class="bg-blue fit"
        ></div>
      </div>
      <q-btn
        @click="$emit('updateActiveIndex', props.idx)"
      ...
      <div class="row items-center">
        ...
        <q-btn
          ...
          outline
          dense
          @click="$emit('playerTimestamp', range.min)"
        >
      ...
      <div class="row items-center">
        ...
        <q-btn
          ...
          outline
          dense
          @click="$emit('playerTimestamp', range.max)"
        >
          <q-icon size="18px"><i-mdi-skip-forward /></q-icon>
        </q-btn>
      </div>
    ...
    <q-range
      ...
      :max="runtimeSeconds"
      v-model="range"
      class="full-width q-mt-sm q-px-sm"
      :color="getColorByType(segment.Type)"
    >
    </q-range>
  </div>
